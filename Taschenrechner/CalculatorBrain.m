...
-(void) setOperand:(double)anOperand{
    ...
    [internalExpression addObject:[[NSNumber alloc] initWithInt:anOperand]];
}
...
- (void)setVariableAsOperand:(NSString *)variableName{
    ...
    //NSLog(@"internalExpression: %@",internalExpression);
}

-(id) getExpression{
    NSMutableArray *newArray = [[NSMutableArray alloc]
                                initWithArray:internalExpression copyItems:YES];
